...
public class UIUpdateSystem : SystemBase
{
    ...
    protected override void OnUpdate()
    {
        ...
        if (somethingChangedFlag)
        {
            ...
            Entities.WithAll<isRabbitTag>().ForEach((ref SizeData sizeData, in GenderData genderData) =>
            {
                if(genderData.gender == GenderData.Gender.Male)
                    sizeData.size = malesize;
                else if (genderData.gender == GenderData.Gender.Female)
